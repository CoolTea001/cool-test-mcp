---
name: cool-design
description: Project-specific frontend design skill based on the Nuxt UI and Tailwind CSS v4 design system, blending design constraints with general design methodology. Use for all UI implementation and page design tasks. Dark mode is the default theme.
brand:
  green: "#00DC82"
  navy: "#020420"
  white: "#FFFFFF"
